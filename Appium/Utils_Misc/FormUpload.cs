...
public static class FormUpload
{
    ...
    public class FileParameter
    {
        ...
        public FileParameter(string formParamName, byte[] file) : this(file, null)
        {
        ...
        public FileParameter(Dictionary<string, string> param)
        {
            FormParamName = param["FormParamName"] ?? "";
